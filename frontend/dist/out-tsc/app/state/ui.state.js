...
export class SetEditorStyleGlobal {
    static { this.type = '[Ui] SetEditorStyleGlobal'; }
    constructor(patch) {
        this.patch = patch;
    }
}
...
let UiState = class UiState {
    ...
    setStyle(ctx, { patch }) { ctx.patchState(patch); }
};
__decorate([
    Action(SetTemplate)
...
__decorate([
    Action(SetEditorStyleGlobal)
], UiState.prototype, "setStyle", null);
__decorate([
    Selector()
], UiState, "cssClass", null);
__decorate([
    Selector()
], UiState, "editorStyle", null);
UiState = __decorate([
