...
let TemplateSelectorComponent = class TemplateSelectorComponent {
    constructor(templateService) {
        ...
        this.allTemplates = [];
        this.scrollPercentage = 20; // Initial thumb width
    }
    ngOnInit() {
    ...
    updateScrollbar() {
        ...
        if (scrollWidth > clientWidth) {
            ...
            const thumbElement = document.querySelector('.scrollbar-thumb');
            if (thumbElement) {
...
__decorate([
    Input()
], TemplateSelectorComponent.prototype, "selectedTemplateId", void 0);
__decorate([
    Output()
], TemplateSelectorComponent.prototype, "templateSelected", void 0);
__decorate([
    ViewChild('scrollContainer')
], TemplateSelectorComponent.prototype, "scrollContainer", void 0);
