...
let PreviewPaneComponent = class PreviewPaneComponent {
    ...
    buildPagesHeuristic() {
        ...
        const pages = [];
        const pushSkill = (skill) => currentPage.skills.push(skill);
        const pushLanguage = (lang) => currentPage.languages.push(lang);
        let currentPage = this.emptyPage(true);
    ...
    estimateContactHeight() {
        const hasContact = (this.personalDetails?.givenName || this.personalDetails?.familyName || this.personalDetails?.emailAddress || this.personalDetails?.phoneNumber || this.personalDetails?.city);
    ...
    footerHeight() {
        return 48; // Reserve space for "Created with AlignCV"
    }
        ...
        >
          ...
          >
            ...
            <div class="resume-main">
              ...
              <div
                class="mt-8 pt-4 border-t text-xs text-gray-400 text-center"
                [style.border-color]="currentPrimaryColor"
                [ngStyle]="{ 'margin-top': 'auto', 'padding-bottom': '12px' }"
              >
