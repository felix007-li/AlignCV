...
let SeoContentComponent = class SeoContentComponent {
    constructor(route, router, mdxService, titleService, metaService) {
        this.route = route;
        this.router = router;
        this.mdxService = mdxService;
...
SeoContentComponent = __decorate([
    Component({
...
export { SeoContentComponent };
//# sourceMappingURL=seo-content.component.js.map